...
- 🤖 **AI 分析** - 智能转录音频并提取核心观点、一句话概括（基于阿里云百炼 DashScope）
...
**2026-04-11**
- ✨ AI 分析服务从 iDealab 迁移至阿里云百炼 DashScope（qwen-max 模型）
- ✨ 语音转录统一使用百炼 paraformer-v2 模型
- ✨ 简化 API 配置：只需一个百炼 API Key 即可使用全部 AI 功能
- ✨ 优化 API 配置 UI：支持明文/密文显示切换、自动保存、清除功能
- ✨ 添加模型说明提示，明确展示使用的 AI 模型
- ✨ 添加转录任务超时控制（30 分钟）
- ✨ 优化 JSON 安全解析，提升 AI 响应处理稳定性
- 🔧 移除 iDealab 相关依赖和配置
